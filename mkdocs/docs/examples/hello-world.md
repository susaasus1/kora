...
Данный пример демонстрирует, как создать простой сервис на Kora с настроенными метриками, логированием и пробами, который умеет отвечать на запрос `GET /hello/world`.
